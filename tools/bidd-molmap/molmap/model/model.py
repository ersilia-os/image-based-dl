...
class MultiClassEstimator_largedata(BaseEstimator, ClassifierMixin):
    ...
    def get_params(self, deep=True):
        ...
        model_paras =  {
                        ...
                        "name":self.name,
                        "gpuid": self.gpuid,
                        "callbacks_path": self.callbacks_path,
                       }
    ...
    def fit(self, Xy, Xy_valid = None):
        
        X0 = Xy[0]
        X = X0[0] # set (X1, X2 for the first batch)
        ...
        checkpoint_callback = ModelCheckpoint(self.callbacks_path, monitor='val_loss', verbose=1, save_best_only=True, mode='mtin')
        
        history = self._model.fit(Xy, 
                                  epochs= self.epochs, 
                                  verbose= 0, 
    ...
    def score(self, Xy):
        score = self._model.evaluate(Xy, verbose=0)
